...
# Bot token @Botfather
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7134772342:AAG5pRhX3oTPMyhpXIdfbFZcI0p2Wi0TXjE")
...
ADMINS = int(os.environ.get("ADMINS", "6951452958"))
...
DB_NAME = os.environ.get("DB_NAME", "ysavecontentbot")
